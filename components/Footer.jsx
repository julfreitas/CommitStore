  ...
  const linkSections = [
    {
      title: "PRODUTOS",
      links: [
        { text: "Fones de ouvido", path: '/', icon: null },
        { text: "Headsets", path: '/', icon: null },
        { text: "Smartphones", path: '/', icon: null },
        { text: "Notebooks", path: '/', icon: null },
      ]
    },
    {
      title: "SITE",
      links: [
        { text: "Início", path: '/', icon: null },
        { text: "Política de Privacidade", path: '/', icon: null },
        { text: "Torne-se Membro Plus", path: '/pricing', icon: null },
        { text: "Crie sua Loja", path: '/create-store', icon: null },
      ]
    },
    {
      title: "CONTATO",
    ...
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Bem-vindo à gocart, seu destino definitivo para os gadgets mais novos e inteligentes. De smartphones e smartwatches a acessórios essenciais, trazemos o melhor da inovação — tudo em um só lugar.
            </p>
        ...
        <p className="py-4 text-sm text-slate-500">
          Direitos autorais 2025 © gocart. Todos os direitos reservados.
        </p>
      </div>
    </footer>
  );
