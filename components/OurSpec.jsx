...
const OurSpecs = () => {
  return (
    <div className='px-6 my-20 max-w-6xl mx-auto'>
      <Title
        visibleButton={false}
        title='Nossas Especificações'
        description="Oferecemos serviço de primeira linha e conveniência para garantir que sua experiência de compra seja tranquila, segura e totalmente sem complicações."
      />
