...
export default function AdminCoupons() {
  ...
  return (
    <div className="text-slate-500 mb-40">
      ...
      <form
        onSubmit={(e) =>
          toast.promise(handleAddCoupon(e), { loading: "Adicionando cupom..." })
        }
        className="max-w-sm text-sm"
      >
        <h2 className="text-2xl">
          Adicionar <span className="text-slate-800 font-medium">Cupons</span>
        </h2>
      ...
      <div className="mt-14">
        <h2 className="text-2xl">
          Listar <span className="text-slate-800 font-medium">Cupons</span>
        </h2>
            ...
            <tbody className="divide-y divide-slate-200">
              {coupons.map((coupon) => (
                <tr key={coupon.code} className="hover:bg-slate-50">
                  ...
                  <td className="py-3 px-4 text-slate-800">
                    {coupon.forNewUser ? "Sim" : "Não"}
                  </td>
                  <td className="py-3 px-4 text-slate-800">
                    {coupon.forMember ? "Sim" : "Não"}
                  </td>
                  <td className="py-3 px-4 text-slate-800">
                    <DeleteIcon
                      onClick={() =>
