...
export default function StoreAddProduct() {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    try {
      //se nenhuma imagem for carregada
      if (!images[1] && !images[2] && !images[3] && !images[4]) {
        return toast.error("Por favorcarregue pelo menos uma imagem");
      }
      setLoading(true);
      ...
      formData.append("price", productInfo.mrp);
  ...
  return (
    ...
    >
      <h1 className="text-2xl">
        Adicionar Novo{" "}
        <span className="text-slate-800 font-medium">Produto</span>
      </h1>
