...
export default function CreateStore() {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    if (!user) {
      return toast("Por favor, faça login para continuar.");
    }
    try {
    ...
    return (
      <div className="min-h-[80vh] mx-6 flex items-center justify-center text-slate-400">
        <h1 className="text-2xl sm:text-4xl font-semibold">
          Por favor, faça <span className="text-slate-500">login</span> para
          continuar
        </h1>
      </div>
    );
        ...
        <div className="mx-6 min-h-[70vh] my-16">
          ...
          >
            ...
            <input
              ...
              type="text"
              placeholder="Digite o nome de usuário da sua loja"
            ...
            <input
              ...
              type="text"
              placeholder="Digite o telefone de contato da sua loja"
              className="border border-slate-300 outline-slate-400 w-full max-w-lg p-2 rounded"
            />
